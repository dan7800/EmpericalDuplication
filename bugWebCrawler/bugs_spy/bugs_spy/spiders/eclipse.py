...
class EclipseSpider(scrapy.Spider):
    ...
    reports_file_name = 'eclipse_reports.xml'
    log_file_name = 'saved_eclipse_log.txt'
    SETTINGS_SEARCH = 'ECLIPSE_SEARCH_URL'
    SETTINGS_DETAIL_URL = 'ECLIPSE_DETAIL_URL'
    ...
    def start_requests(self):
        ...
        # DEVELOPMENT
        # test_url = {'2019-01-01': base_search_url.format('2019-01-01', '2019-01-30')}
    ...
    def get_monthly_search_urls(self, base_url):
        ...
        for m in range(1, 13):
            ...
            end_month = "%s-%s-%s" % (self.year, m, 30)
